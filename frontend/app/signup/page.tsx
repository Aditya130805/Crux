        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-[rgb(var(--muted-foreground))]">
              Start building your professional graph
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-[rgb(var(--muted-foreground))]">
                Your profile will be at crux.io/{username || 'username'}
              </p>
            </div>
            ...
            <p className="text-center text-sm text-[rgb(var(--muted-foreground))]">
              ...
              <Link href="/login" className="text-[rgb(var(--foreground))] hover:opacity-70 font-medium underline">
                Log in
              </Link>
            </p>
          </form>
      ...
      <div className="hidden lg:flex relative bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 items-center justify-center p-12 overflow-hidden">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-serif text-white mb-6 leading-tight">
            Your career,<br />
            <span className="italic font-light">beautifully</span> mapped.
          </h2>
          <p className="text-lg text-slate-300 mb-8">
            Transform your professional identity into an interactive knowledge graph.
          </p>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm">
            ...
            <span className="text-sm text-slate-300">Join professionals worldwide</span>
          </div>
        </motion.div>
      </div>
    </div>
